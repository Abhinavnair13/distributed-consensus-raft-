...
const file_proto_raft_proto_rawDesc = "" +
	"\n" +
	"\x10proto/raft.proto\x12\x06raftpb\"8\n" +
	"\bLogEntry\x12\x12\n" +
	...
	"\rAppendEntries\x12\x19.raftpb.AppendEntriesArgs\x1a\x1a.raftpb.AppendEntriesReplyB\x13Z\x11raft/proto;raftpbb\x06proto3"
...
var file_proto_raft_proto_depIdxs = []int32{
	...
	1, // 1: raftpb.RaftService.RequestVote:input_type -> raftpb.RequestVoteArgs
	3, // 2: raftpb.RaftService.AppendEntries:input_type -> raftpb.AppendEntriesArgs
	2, // 3: raftpb.RaftService.RequestVote:output_type -> raftpb.RequestVoteReply
	4, // 4: raftpb.RaftService.AppendEntries:output_type -> raftpb.AppendEntriesReply
